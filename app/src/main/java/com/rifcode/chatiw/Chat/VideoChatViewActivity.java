...
public class VideoChatViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (checkSelfPermission(REQUESTED_PERMISSIONS[0], PERMISSION_REQ_ID) &&
            ...
            video_room_id = getIntent().getStringExtra("video_id");
            userIDvisited = getIntent().getStringExtra("hisid");
    ...
    private void dialogReportUser(){
        ...
        btnSentReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dbReportAbuseOfContent.child(myuserID).child(userIDvisited).setValue("Abusive");
                alertDialog.dismiss();
    ...
    private void leaveChannel() {
        dbvideocall.child(myuserID).child(myuserID).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Intent innn = new Intent(VideoChatViewActivity.this,ChatUserActivity.class);
                innn.putExtra("userIDvisited",userIDvisited);
                startActivity(innn);
